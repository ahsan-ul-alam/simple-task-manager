...
<body class="bg-slate-50 text-slate-800 antialiased">
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
            <div class="grid items-center gap-14 lg:grid-cols-2">
                ...
                <!-- Hero Card -->
                <div class="relative">
                    <div class="absolute -top-8 -left-8 h-40 w-40 rounded-full bg-indigo-200 blur-3xl opacity-50"></div>
                            ...
                            <div class="rounded-2xl border border-slate-200 p-4">
                                <div class="flex items-start justify-between gap-4">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-slate-500">Create a clean and modern welcome page
                                            for users.</p>
                                    </div>
                                    <span
    ...
    <footer class="border-t border-slate-200 bg-white">
        <div
            ...
            <p>Built with Laravel, Blade & Tailwind CSS.</p>
        </div>
    </footer>
